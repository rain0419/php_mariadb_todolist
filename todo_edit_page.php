...
if ( isset($_GET['edit_list'])){
    $edit_todo_idx = $_GET['edit_list'];
    $edit_todo_select = $todo_control->getTodoList('todo_idx='.$edit_todo_idx,'*');
...
<div class="container py-5">
    ...
    <!--                                <div id="in_title">-->
                                        ...
                                        <input type='text' class='d-none' name='edit_todo_idx' value='<?php echo $edit_todo['todo_idx'] ?>'>
    <!--                                </div>-->
    <!--                            </div>-->
                            </div>
                        </div>
